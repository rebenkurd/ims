  ...
  <div class="bg-white p-4 rounded-lg shadow">
    ...
    <div class="overflow-x-hidden">
      <table class="table-auto w-full min-w-full">
        ...
        <tbody v-else>
          <tr v-for="customer of customers.data" :key="customer.id" class="animate-fade-in-down">
            <td class="border-b-2 p-2">{{ customer.id }}</td>
            <td class="border-b-2 p-2">{{ customer.name }}</td>
            <td class="border-b-2 p-2">{{ customer.mobile }}</td>
    ...
    <div v-if="!customers.loading" class="flex flex-col md:flex-row md:justify-between items-center mt-5 gap-3">
      <span class="text-sm">
